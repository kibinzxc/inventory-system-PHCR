...
$pdf->Ln(15); // Line break before table
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $pdf->Cell(10, 10, strtoupper($row['uom']), 1, 0, 'C'); // Capitalized and bold 'uom', center-aligned
...
// Output the PDF
//put the week number on file name 
$filename = date('Y-m-d') . '_inventory-report-week-' . $week . '.pdf'; // File name with today's date
