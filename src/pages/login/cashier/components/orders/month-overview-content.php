...
// Query to get distinct years from the usage_reports table
$sql = "SELECT DISTINCT YEAR(day_counted) AS year FROM usage_reports WHERE day_counted IS NOT NULL ORDER BY year DESC";
        ...
        <div class="btn-wrapper2">
            ...
            <script>
                ...
                function changeViewMode() {
                    ...
                    if (viewMode === 'weekly') {
                        window.location.href = 'order-count.php';
