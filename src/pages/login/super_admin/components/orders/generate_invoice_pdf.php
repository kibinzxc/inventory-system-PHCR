...
if (isset($_GET['invID'])) {
    ...
    $pdf->Cell(0, 5, 'Order Type: ' . strtoupper($invoice['order_type']), 0, 1);
    ...
    $financialDetails = [
        'Gross Sales' => 'PHP ' . number_format($invoice['total_amount'], 2),
        'Price exc. of VAT' => 'PHP ' . number_format($vatable, 2),
        'Add: VAT' => 'PHP ' . number_format($vat, 2),
        'Total AMOUNT' => 'PHP ' . number_format($invoice['total_amount'], 2),
