...
//get the total_price from the cart
...
<head>
    ...
    <title>Payment | Pizza Hut Chino Roces</title>
...
<body>
        ...
        <div class="row row-flex">
            ...
            <div class="col-sm-11 wrap" style="padding:15px; height:100vh; ">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="wrapper">
                            <h2><i class="fa-solid fa-utensils" style="margin-left:5px;"></i> Confirm Payment</h2>
                                ...
                                <div class="pay-container">
                                    <div class="pay-card">
                                        <form id="pay-form">
                                            ...
                                            <input type="text" id="amount" name="amount" placeholder="Amount" value="<?php echo number_format($totalPrice, 2); ?>" readonly>
    ...
    <script>
        document.getElementById("pay-form").addEventListener("submit", function(event) {
            ...
            // Simple validation
            if (!name || !cardType || !cardNumber || !expiryDate || !amount || !securityCode) {
            ...
            showSuccess(`Payment of ₱${amount} was successful using your ${cardType} card! The amount will be deducted once the food has been delivered to your address.`);
        });
