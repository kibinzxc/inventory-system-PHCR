...
<div id="mySidebar" class="sidebar">
    ...
    <div class="bglinks">
        ...
        <a href="../orders/orders.php" id='orders' data-tooltip="Inventory" class="<?= ($currentPage == 'online-orders.php' || $currentPage == 'order-logs.php' || $currentPage == 'orders.php') ? 'active' : '' ?>"><img src="../../assets/file-plus.svg" alt=""><span class="links">Orders</span></a>
