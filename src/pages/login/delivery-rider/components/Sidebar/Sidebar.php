...
<div id="mySidebar" class="sidebar">
    ...
    <div class="bglinks">
        ...
        <a href="../orders/online-orders.php" data-tooltip="Inventory" class="<?= ($currentPage == 'accepted-orders.php' || $currentPage == 'online-orders.php' || $currentPage == 'order-logs.php' || $currentPage == 'orders.php') ? 'active' : '' ?>"><img src="../../assets/file-plus.svg" alt=""><span class="links">Orders</span></a>
