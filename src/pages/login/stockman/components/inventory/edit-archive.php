...
<div id="editModal" class="modal">
    <div class="modal-content2">
        ...
        <div class="modal-body">
            <form id="editItemForm" action="update-archive.php" method="POST" onsubmit="return validateForm()">
                <input type="hidden" name="recordID" id="edit-recordID">
                ...
                <div class="form-row">
                    ...
                    <input type="text" id="edit-itemID" name="itemID" readonly>
                </div>
...
<script src="edit_archive.js"></script>