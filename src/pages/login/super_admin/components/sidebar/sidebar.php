...
<div id="mySidebar" class="sidebar">
    ...
    <div class="bglinks">
        ...
        <hr class="hr_style" />
        <a href="../inventory/items.php" data-tooltip="Inventory" class="<?= ($currentPage == 'items.php' || 'transfers-report.php') ? 'active' : '' ?>"><img src="../../assets/package.svg" alt=""><span class="links">Inventory</span></a>
