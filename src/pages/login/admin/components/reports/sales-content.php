...
<div id="main-content">
    ...
    <div class="container">
        ...
        <div class="btncontents">
            ...
            <a href="reports.php"><img src="../../assets/cutlery.png" class="img-btn-link">Products</a>
            <a href="sales.php" class="active"><img src="../../assets/graph.png" class="img-btn-link">Sales</a>
        </div>
        <br>
        ...
        <div class="same-column-container">
            <div class="same-column">
                <div class="table_container daily_sales"> <?php include '../dashboard/daily_sales.php'; ?></div>
