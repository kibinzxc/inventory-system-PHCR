...
<div id="mySidebar" class="sidebar">
    ...
    <div class="bglinks">
        ...
        <hr class="hr_style" />
        <a href="../inventory/items.php" data-tooltip="Inventory" class="<?= ($currentPage == 'archive.php' || $currentPage == 'items.php' || $currentPage == 'daily-summary.php' || $currentPage == 'products.php' || $currentPage == 'spoilage-report.php' || $currentPage == 'transfers-report.php' || $currentPage == 'deliveries-report.php') ? 'active' : '' ?>"><img src="../../assets/package.svg" alt=""><span class="links">Inventory</span></a>
        <a href="../inventory/items.php" data-tooltip="Inventory" class="<?= ($currentPage == 'products-usage.php') ? 'active' : '' ?>"><img src="../../assets/clipboard.svg" alt=""><span class="links">Products</span></a>
