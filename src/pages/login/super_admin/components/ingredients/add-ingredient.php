<link rel="stylesheet" href="add-ingredient.css">
<div id="addModal" class="modal" style="display: <?php echo $showModal ? 'block' : 'none'; ?>;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="addIngredientForm" action="add-ingredient-query.php" method="POST">
        ...
        <div class="modal-footer">
            ...
            <button type="submit" form="addIngredientForm" class="custom_btn save-btn">Save Changes</button>
        </div>
    </div>
</div>

<script src="add-ingredient.js"></script>